...
import 'package:master_app/app_constants.dart';
import 'package:master_app/dashboard.dart';
import 'package:master_app/login.dart';
import 'package:master_app/utils/demo_meta_info_constants.dart';
...
class _GuardScreenState extends State<GuardScreen> {
  ...
  Widget build(BuildContext context) {
    return (shouldGoToHomeScreen != null && shouldGoToHomeScreen!)
        ? Dashboard()
        : const Login();
  }
}
