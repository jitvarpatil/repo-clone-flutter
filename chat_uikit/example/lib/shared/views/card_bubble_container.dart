...
WidgetProps getCardBubbleContainer(BuildContext context) {
  CardMessage cardMessage = CardMessage(
      text: "Chat & messaging\n"
          "Flexible, scalable and feature rich UI Kits and SDKs for your in-app messaging",
      cardActions: [
        ButtonElement(
            elementId: "navigation1",
            buttonText: "Check this",
            action: URLNavigationAction(url: "https://www.cometchat.com/")),
        ButtonElement(
            elementId: "navigation2",
            buttonText: "Check this",
            action: URLNavigationAction(url: "https://www.cometchat.com/")),
      ],
